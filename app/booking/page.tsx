      ...
      <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-[0.95fr_1.05fr]">
        <section className="flex flex-col justify-center">
          ...
          <h1 className="mt-6 max-w-xl text-4xl font-bold leading-tight md:text-6xl">
            Booking kursi barber secara langsung tanpa perlu buat akun.
          </h1>
          <p className="mt-5 max-w-lg text-base leading-7 text-white/70">
            Pelanggan cukup isi nomor WhatsApp, pilih layanan, tanggal, dan jam. Pesanan akan langsung masuk ke dashboard admin.
          </p>
