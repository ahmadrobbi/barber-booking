...
const plans = [
  {
    ...
    price: "Rp 0",
    description:
      "Untuk validasi awal merchant baru yang ingin mencoba shared AI assistant sebelum masuk paket berbayar.",
    accent: "bg-blue-50 text-blue-700",
    features: ["1 merchant", "1 cabang", "FAQ AI dasar", "Booking sandbox"],
  },
  {
    name: "Starter",
    price: "Rp 299.000",
    description:
      "Paket awal untuk merchant aktif yang ingin AI menjawab FAQ, cabang, jam buka, dan booking dasar dari satu nomor official.",
  ...
  },
  {
    ...
    price: "Custom",
    description:
      "Untuk merchant yang butuh banyak cabang, knowledge khusus, handoff ke admin, dan SLA yang lebih serius.",
...
const addOns = [
  "Dedicated WhatsApp number untuk merchant tertentu",
  "Cabang tambahan di luar kuota paket",
  "Custom prompt / knowledge tuning per merchant",
      ...
      <section className="mx-auto max-w-7xl px-6 py-8 sm:px-8 lg:px-10">
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr_0.95fr] lg:items-end">
          <div>
            ...
            <h1 className="mt-4 max-w-3xl text-3xl font-bold leading-tight text-slate-900 sm:text-4xl md:text-5xl">
              Pricing yang cocok untuk shared AI assistant dan tetap mudah dijual ke merchant jasa.
            </h1>
            <p className="mt-5 max-w-2xl text-sm leading-7 text-slate-600 md:text-base">
              Harga di halaman ini masih draft awal. Fokusnya adalah validasi pasar: satu nomor WhatsApp
              Official, banyak merchant di belakangnya, dan AI yang membaca data dari database sebelum
              menjawab pelanggan.
            </p>
          </div>
          ...
          <div className="rounded-[2rem] border border-blue-200 bg-white p-6 shadow-xl shadow-blue-950/5">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-900">Per merchant, bukan per chatbot</h2>
            <ul className="mt-5 space-y-3 text-sm leading-7 text-slate-600">
              <li>AI jawab FAQ dari data merchant</li>
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-[1fr_0.9fr]">
          <section className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-slate-900">Kalau merchant butuh lebih jauh</h2>
          ...
          <section className="rounded-[2rem] border border-slate-200 bg-slate-900 p-8 text-white shadow-sm">
            ...
            <p className="mt-4 text-sm leading-7 text-slate-300">
              ...
              Paket lain bisa tetap ada sebagai draft internal, lalu diumumkan setelah pilot merchant
